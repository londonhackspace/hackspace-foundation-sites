...
class NordProcessor():
    ...
    def process_transactions(self):
        ...
        transactions = self.client.account.transactions(
            self.account)["transactions"]["booked"]

        f = open('lhs-transactions-data.json', "r")
        transactions = json.loads(f.read())
        f.close()

        for trn in transactions["booked"]:
    ...
    def process_transaction(self, tx):
        ...
        # generate a hash of the remittance info for use in uniqueness
