...
update users_profile set website     = replace(replace(website,     '&#34;', '"'), '&#39;', '''') where website     like '%&#%';
update users_profile set description = replace(replace(description, '&#34;', '"'), '&#39;', '''') where description like '%&#%';
